...
<template>
  <div ref="labelContainer" class="pointer-events-auto">
    <img v-if="isShowMini" class="mt-[260px]" @click="handleClick" src="/images/system/云端ddos攻击阵地路径缩略面板.png" alt="">
    <img v-else @click="handleClick" src="/images/system/云端ddos攻击阵地路径大面板.png" alt="">
  </div>
</template>
