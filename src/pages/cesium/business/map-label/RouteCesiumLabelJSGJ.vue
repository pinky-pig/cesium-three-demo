...
<template>
  <div ref="labelContainer" class="pointer-events-auto">
    <img v-if="isShowMini" class="mt-[260px]" @click="handleClick" src="/images/system/僵尸攻击阵地路径缩略面板.png" alt="">
    <img v-else @click="handleClick" src="/images/system/僵尸攻击阵地路径缩略大面板.png" alt="">
  </div>
</template>
